...
INSERT INTO `Books` VALUES (1,'title1','mystery',1,5.00,'waffles',12.00,0.00),(2,'title2','Horror',12,3.00,'tattoo',0.00,0.00),(3,'title3','fantasy',15000,5.00,'strawberry',23.00,0.00),(4,'title4','sci-fi',500,3.00,'entertainment',40.00,0.00),(5,'title5','childrens',50000,4.00,'toysrus',10.00,0.00),(6,'title6','nonfiction',1,2.00,'roman',0.00,0.00);
...
INSERT INTO `CartItem` VALUES (1,1,1,1,12.99),(2,1,1,2,20.99),(3,1,1,3,35.99),(4,3,1,4,50.00),(7,3,5,1,0.00),(8,3,5,1,0.00),(9,3,1,1,0.00),(10,3,1,1,0.00),(11,3,1,1,0.00),(12,3,1,1,0.00),(13,3,1,1,0.00),(14,3,1,1,0.00),(15,NULL,1,1,0.00),(16,NULL,1,1,0.00);
...
CREATE TABLE `ShoppingCart` (
  ...
  KEY `item_id_idx` (`cart_id`),
  CONSTRAINT `item_id` FOREIGN KEY (`cart_id`) REFERENCES `CartItem` (`item_id`),
  CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `UserProfile` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ShoppingCart` VALUES (3,NULL);
...
-- Dump completed on 2023-11-06 18:47:46
